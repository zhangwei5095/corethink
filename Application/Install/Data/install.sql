...
VALUES
	...
	('图片上传大小','UPLOAD_IMAGE_SIZE','2',2,'num','','图片上传大小单位：MB',1428681071,1428681071,6,1),
	('敏感字词','SENSITIVE_WORDS','傻逼,垃圾',2,'textarea','','用户注册及内容显示敏感字词',1420385145,1420387079,7,1),
	('后台主题','ADMIN_THEME', 'default',3,'select','default:默认主题\r\nblueidea:蓝色理想\r\ngreen:绿色生活','后台界面主题',1436678171,1436690570,1,1),
	('URL模式','URL_MODEL','3',3,'select','0:普通模式\r\n1:PATHINFO模式\r\n2:REWRITE模式\r\n3:兼容模式','',1438423248,1438423248,2,1),
	...
	('静态资源版本标识','STATIC_VERSION','20150803',3,'text', '','静态资源版本标识可以防止服务器缓存',1438564784,1438564784,5,1),
	('配置分组','CONFIG_GROUP_LIST','1:基本\r\n2:用户\r\n3:系统\r\n4:上传\r\n',3,'array','','配置分组',1379228036,1426930700,6,1),
	('分页数量','ADMIN_PAGE_ROWS','10',3,'num','','分页时每页的记录数',1434019462,1434019481,7,1),
	('栏目分组','CATEGORY_GROUP_LIST','1:默认\r\n3:导航\r\n',3,'array','','栏目分类分组',1433602137,1433602165,8,1),
...
VALUES
	...
	(5,0,'其它','','glyphicon glyphicon-cloud',0,1426580628,1426580628,3,0),
	(6,1,'系统操作','','',0,1426580628,1426580628,1,1),
	(7,2,'系统功能','','fa fa-folder-open-o',0,1426580628,1438277612,1,1),
	(8,2,'数据备份','','fa fa-folder-open-o',0,1426580628,1426580628,2,1),
	(9,3,'内容管理','','fa fa-folder-open-o',0,1430290276,1438277591,1,1),
	(10,3,'文件管理','','fa fa-folder-open-o',0,1430290276,1438277393,1,1),
	(11,4,'用户管理','','fa fa-folder-open-o',0,1426580628,1438277454,1,1),
	...
	(19,15,'字段管理','Admin/DocumentAttribute/index','',0,1426580628,1430291065,1,1),
	(20,19,'添加','Admin/DocumentAttribute/add','',0,1426580628,1426580628,1,1),
	(21,19,'编辑','Admin/DocumentAttribute/edit','',0,1426580628,1426580628,2,1),
	(22,19,'设置状态','Admin/DocumentAttribute/setStatus','',0,1426580628,1426580628,3,1),
	(23,7,'菜单管理','Admin/SystemMenu/index','fa fa-bars',1,1426580628,1438276552,3,1),
	(24,23,'添加','Admin/SystemMenu/add','',0,1426580628,1426580628,1,1),
	(25,23,'编辑','Admin/SystemMenu/edit','',0,1426580628,1426580628,2,1),
	(26,23,'设置状态','Admin/SystemMenu/setStatus','',0,1426580628,1426580628,3,1),
	(27,7,'配置管理','Admin/SystemConfig/index','fa fa-cogs',1,1426580628,1438276571,4,1),
	(28,27,'添加','Admin/SystemConfig/add','',0,1426580628,1426580628,1,1),
	(29,27,'编辑','Admin/SystemConfig/edit','',0,1426580628,1426580628,2,1),
	(30,27,'设置状态','Admin/SystemConfig/setStatus','',0,1426580628,1426580628,3,1),
	(31,7,'数据字典','Admin/Datebase/index','fa fa-database',1,1429851071,1438276624,5,1),
	(32,7,'插件列表','Admin/Addon/index','fa fa-th',0,1427475588,1438277115,6,1),
	(33,32,'安装','Admin/Addon/install','',0,1427475588,1427475588,1,1),
	(34,32,'卸载','Admin/Addon/uninstall','',0,1427475588,1427475588,2,1),
	(35,32,'执行','Admin/Addon/execute','',0,1427475588,1427475588,3,1),
	(36,32,'插件设置','Admin/Addon/config','',0,1427475588,1427475588,4,1),
	(37,32,'数据列表','Admin/Addon/adminList','',0,1427475588,1427475588,5,1),
	(38,8,'数据备份','Admin/Datebase/export','fa fa-copy',0,1426580628,1426580628,3,1),
	(39,38,'备份','Admin/Datebase/do_export','',0,1426580628,1426580628,1,1),
	(40,38,'优化表','Admin/Datebase/optimize','',0,1426580628,1426580628,2,1),
	(41,38,'修复表','Admin/Datebase/repair','',0,1426580628,1426580628,3,1),
	(42,8,'数据还原','Admin/Datebase/import','fa fa-refresh',1,1426580628,1438276890,2,1),
	(43,42,'还原备份','Admin/Datebase/do_import','',0,1426580628,1426580628,1,1),
	(44,42,'删除备份','Admin/Datebase/del','',0,1426580628,1426580628,2,1),
	(45,9,'栏目分类','Admin/Category/index','fa fa-th-list',0,1426580628,1438277233,1,1),
	(46,45,'添加','Admin/Category/add','',0,1426580628,1426580628,1,1),
	(47,45,'编辑','Admin/Category/edit','',0,1426580628,1426580628,2,1),
	(48,45,'设置状态','Admin/Category/setStatus','',0,1426580628,1426580628,3,1),
	(50,45,'文档列表','Admin/Document/index','',0,1427475588,1427475588,4,1),
	(51,50,'添加','Admin/Document/add','',0,1426580628,1426580628,1,1),
	(52,50,'编辑','Admin/Document/edit','',0,1426580628,1426580628,2,1),
	(53,50,'设置状态','Admin/Document/setStatus','',0,1426580628,1426580628,3,1),
	(54,9,'标签列表','Admin/Tag/index','fa fa-tags',0,1426580628,1438277250,3,1),
	(55,54,'添加','Admin/Tag/add','',0,1426580628,1426580628,1,1),
	(56,54,'编辑','Admin/Tag/edit','',0,1426580628,1426580628,2,1),
	(57,54,'设置状态','Admin/Tag/setStatus','',0,1426580628,1426580628,3,1),
	(58,9,'万能评论','Admin/UserComment/index','fa fa-comments',0,1426580628,1438277284,4,1),
	...
	(66,63,'文件浏览','Admin/Upload/fileManager','',0,1427475588,1427475588,3,1),
	(67,11,'用户列表','Admin/User/index','fa fa-user',0,1426580628,1438277505,1,1),
	(68,67,'添加','Admin/User/add','',0,1426580628,1426580628,1,1),
	(69,67,'编辑','Admin/User/edit','',0,1426580628,1426580628,2,1),
	(70,67,'设置状态','Admin/User/setStatus','',0,1426580628,1426580628,3,1),
	(71,11,'部门管理','Admin/UserGroup/index','fa fa-sitemap',0,1426580628,1438277438,2,1),
	(72,71,'添加','Admin/UserGroup/add','',0,1426580628,1426580628,1,1),
	(73,71,'编辑','Admin/UserGroup/edit','',0,1426580628,1426580628,2,1),
	(74,71,'设置状态','Admin/UserGroup/setStatus','',0,1426580628,1426580628,3,1),
	(75,32,'新增数据','Admin/Addon/adminAdd','',0,1426580628,1426580628,6,1),
