...
VALUES
	...
	('CDN静态资源列表', 'CDN_RESOURCE_LIST', '', 3, 'textarea', '', '配置此项后系统自带的jquery等类库将不会再重复加载', 1438564784, 1438564784, 6, 1),
	('系统加密KEY', 'AUTH_KEY', 'CoreThink', 3, 'textarea', '', '轻易不要修改此项，否则容易造成用户无法登录；如要修改，务必备份原key', 1438647773, 1438647815, 7, 1),
	('配置分组','CONFIG_GROUP_LIST','1:基本\r\n2:用户\r\n3:系统\r\n4:上传\r\n',3,'array','','配置分组',1379228036,1426930700,8,1),
	('分页数量','ADMIN_PAGE_ROWS','10',3,'num','','分页时每页的记录数',1434019462,1434019481,9,1),
...
VALUES
	...
	(91,88,'设置状态','Admin/UserGroup/setStatus','',0,1426580628,1426580628,3,1);
