...
VALUES
	(1,0,'首页','Admin/Index/index','fa fa-home',1426580628,1438276217,1,1),
	(2,0,'系统','Admin/SystemConfig/group','fa fa-cog',1426580628,1438276235,2,1),
	(3,0,'内容','Admin/Category/index','fa fa-tasks',1430290092,1438276260,2,1),
	(4,0,'用户','Admin/User/index','fa fa-users',1426580628,1438276990,3,1),
	(5,0,'其它','','glyphicon glyphicon-cloud',1426580628,1426580628,3,0),
	(6,1,'系统操作','','',1426580628,1426580628,1,1),
	(7,2,'系统功能','','fa fa-folder-open-o',1426580628,1438277612,1,1),
	(8,2,'数据备份','','fa fa-folder-open-o',1426580628,1426580628,2,1),
	(9,3,'内容管理','','fa fa-folder-open-o',1430290276,1438277591,1,1),
	(10,3,'文件管理','','fa fa-folder-open-o',1430290276,1438277393,1,1),
	(11,4,'用户管理','','fa fa-folder-open-o',1426580628,1438277454,1,1),
	(12,6,'清空缓存','Admin/Index/rmdirr','',1427475588,1427475588,1,1),
	(13,7,'系统设置','Admin/SystemConfig/group','fa fa-gears',1426580628,1438276516,1,1),
	(14,13,'修改','Admin/SystemConfig/groupSave','',1426580628,1426580628,1,1),
	(15,7,'文档类型','Admin/DocumentType/index','fa fa-th-list',1426580628,1438277140,2,1),
	...
	(23,7,'菜单管理','Admin/SystemMenu/index','fa fa-bars',1426580628,1438276552,3,1),
	...
	(27,7,'配置管理','Admin/SystemConfig/index','fa fa-cogs',1426580628,1438276571,4,1),
	...
	(31,7,'数据字典','Admin/Datebase/index','fa fa-database',1429851071,1438276624,5,1),
	(32,7,'插件列表','Admin/Addon/index','fa fa-th',1427475588,1438277115,6,1),
	...
	(38,8,'数据备份','Admin/Datebase/export','fa fa-copy',1426580628,1426580628,3,1),
	...
	(42,8,'数据还原','Admin/Datebase/import','fa fa-refresh',1426580628,1438276890,2,1),
	(43,42,'还原备份','Admin/Datebase/do_import','',1426580628,1426580628,1,1),
	(44,42,'删除备份','Admin/Datebase/del','',1426580628,1426580628,2,1),
	(45,9,'栏目分类','Admin/Category/index','fa fa-th-list',1426580628,1438277233,1,1),
	...
	(54,9,'标签列表','Admin/Tag/index','fa fa-tags',1426580628,1438277250,3,1),
	...
	(58,9,'万能评论','Admin/UserComment/index','fa fa-comments',1426580628,1438277284,4,1),
	...
	(62,9,'回收站','Admin/Document/recycle','fa fa-refresh',1427475588,1438277313,5,1),
	(63,10,'上传管理','Admin/Upload/index','fa fa-upload',1427475588,1438277518,1,1),
	...
	(67,11,'用户列表','Admin/User/index','fa fa-user',1426580628,1438277505,1,1),
	...
	(71,11,'部门管理','Admin/UserGroup/index','fa fa-sitemap',1426580628,1438277438,2,1),
	...
	(78,2,'应用商店','','fa fa-folder-open-o',1437185077,1437185164,2,1),
	(79,78,'功能模块','Admin/StoreModule/index','fa fa-th-large',1437185242,1438276915,1,1),
	(80,78,'前台主题','Admin/StoreTheme/index','fa fa-adjust',1437185290,1438277065,2,0),
	(81,78,'全局插件','Admin/StoreAddon/index','fa fa-th',1437185290,1438277092,3,0);
