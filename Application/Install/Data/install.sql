...
VALUES
	(1,0,1,3,'产品中心','','','','',1,'fa fa-send-o',1431926468,1435895071,1,1),
	(2,0,1,3,'新闻动态','','','','',1,'fa fa-send-o',1431926468,1435895071,1,1),
	(3,0,1,3,'客户服务','','','','',1,'fa fa-send-o',1431926468,1435895071,1,1),
	(4,0,1,3,'案例展示','','','','',1,'fa fa-send-o',1431926468,1435895071,1,1),
	(5,0,1,3,'联系我们','','','','',1,'fa fa-send-o',1431926468,1435895071,1,1),
	...
	(26,25,3,1,'CoreThink','','','','',0,'',1435922823,1435922823,0,1),
	(27,25,3,1,'OpenCMF','','','','',0,'',1435922866,1435923215,0,1),
...
VALUES
	...
	(21,'系统加密KEY','AUTH_KEY','CoreThink',3,'textarea','','轻易不要修改此项，否则容易造成用户无法登录；如要修改，务必备份原key',1438647773,1438647815,7,1),
	(22,'配置分组','CONFIG_GROUP_LIST','1:基本\r\n2:用户\r\n3:系统\r\n',3,'array','','配置分组',1379228036,1426930700,8,1),
	(23,'分页数量','ADMIN_PAGE_ROWS','10',3,'num','','分页时每页的记录数',1434019462,1434019481,9,1),
	(24,'栏目分组','CATEGORY_GROUP_LIST','1:默认\r\n3:导航\r\n',3,'array','','栏目分类分组',1433602137,1433602165,10,1);
